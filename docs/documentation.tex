...
periodic X/Y boundaries by default; this can be disabled with
\texttt{--no-surface-periodic-xy}.
...
\item[\texttt{--surface-periodic-xy}]
Connect local 2-1 / 4-1 surface lattice bonds across periodic X/Y
boundaries. Enabled by default; use \texttt{--no-surface-periodic-xy}
to disable it.
